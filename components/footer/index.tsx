      ...
      <div className="md:flex md:justify-between">
        <div className="grid grid-cols-2 md:grid-cols-6 md:gap-6 ">
          <div className="mb-6 md:mb-0 col-span-2">
            ...
            <p className="text-sm text-gray-500 sm:text-left dark:text-gray-400">
          ...
          <div>
            <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase text-black">Market Place</h2>
          ...
          <div>
            <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase text-black">My Account</h2>
            <ul className="text-gray-600 dark:text-gray-400">
              <li>
                <a href="#" className="hover:underline ">
                  Profile
          ...
          <div className="col-span-2 md:mt-0 mt-4">
            ...
            <form>
              <div className="relative">
                ...
                <button
                  type="submit"
                  className="text-white absolute right-2.5 bottom-2.5 bg-primary hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm px-4 py-2 ">
                  Subscribe Now
                </button>
              </div>
            </form>
